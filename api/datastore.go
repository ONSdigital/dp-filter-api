...
type DataStore interface {
	...
	GetFilterDimension(filterID string, name, eTagSelector string) (dimension *models.Dimension, eTag string, err error)
	...
	UpdateFilterOutput(filter *models.Filter, timestamp bson.MongoTimestamp, eTag string) error
